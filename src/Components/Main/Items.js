        ...
        return (
          <ItemCard key={i} backgroundImg={itemImg}>
            <div className="gameCardNum">
              {itemNum}
              <div
                className="gameCardMoreInfo"
                ref={clickElementRef}
                onClick={() =>
                  setReomoveButtonSeq((pre) => (pre === itemNum ? '' : itemNum))
                }
              >
                <BsThreeDots />
              </div>
            ...
            <div
              ...
              onClick={() => handleImgClick(itemLink)}
            >
              {itemStockStatus ? (
            ...
            {itemPrice && <div className="gameCardTitle">${itemPrice}</div>}
            <div className="gameCardContent">{itemName}</div>
          </ItemCard>
        )
      })}
    </GamesContainer>
